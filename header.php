...
<head>
  ...
  <title>Municipalidad Provincial de Carabaya - Macusani</title>
...
<div class="fixed-top">
    ...
    <section id="topbar" class="d-none d-lg-block">
      <div class="container clearfix">
        ...
        <a href="tel:+51987529228"><i class="icofont-phone"></i>987 529 228</a> 
    ...
    <header id="header">
      <div class="container d-flex align-items-center">
        ...
        <h1 class="logo mr-auto"><a href="index.php">MPC-M</a></h1>
          ...
          <ul>
            ...
            <li class="drop-down"><a href="municipalidad.php"><i class="icofont-university"></i>&nbsp;MUNICIPALIDAD</a>
              <ul>
                ...
                <li><a href="municipalidad.php#pricing">Visión y Misión</a></li>
                <li><a href="municipalidad.php#concejomunicipal">Concejo Municipal</a></li>
